...
CONFIGFOLDER='/root/.ufy'
COIN_DAEMON='ufyd'
COIN_CLI='ufy-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/UfyCoin/UFY/releases/download/v1.0.1.0/UnifyCoin_Daemon_Ubuntu16.04.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='ufyd'
COIN_EXPLORER='http://explorer.unifycoin.com'
COIN_PORT=51228
RPC_PORT=51227
